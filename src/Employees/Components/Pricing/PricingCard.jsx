...
const PricingCard = ({ heading, price, description, additionalClasses }) => {
  return (
    <div className={`bg-gray-200 shadow-lg rounded-lg p-8 max-w-sm mx-auto ${additionalClasses}`}>
      ...
      <button className="w-full py-2 bg-gray-300 text-gray-800 rounded-full hover:bg-gray-400 transition duration-300 ease-in-out mb-4">
        Choose {heading} Plan
      </button>
