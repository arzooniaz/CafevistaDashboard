...
import CreateNewProjectPage from "../Components/Projects/CreateNewProject/CreateNewProjectPage";
...
const EmployeeLayout = () => {
  ...
  const [createNewProjectPage, setCreateNewProjectPage] = useState(false);
  ...
  function HandleCreateNewProjectScreen() {
    setCreateNewProjectPage(!createNewProjectPage);
  }
        ...
        <div className="page-layout__content grid lg:grid-cols-12 relative">
          ...
          <div className="content-area min-h-screen sm:col-span-9 lg:col-span-10 bg-page-secondary relative">
            ...
            <div className="main-pages min-h-screen">
              {activePageBtn.title === "Projects" && (
                <Projects
                  HandleCreateNewProjectScreen={HandleCreateNewProjectScreen}
                />
              )}
